        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">MODELES D'ANATOMIE HUMAINE</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="#">ACCUEIL</a></li>
                      <li class="breadcrumb-item"><a href="#">Catégories</a></li>
                      <li class="breadcrumb-item"><a href="#"></a>MODELES D'ANATOMIE HUMAINE</li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="shuffle-btn-group">
          ...
          <label for="tete-cerveau">
            <input type="radio" name="shuffle-filter" id="tete-cerveau" value="tete-cerveau">Tête et Cerveau
          </label>
          <label for="organes-sensoriels">
            <input type="radio" name="shuffle-filter" id="organes-sensoriels" value="organes-sensoriels">Organes Sensoriels: Yeux et Oreille
          </label>
          <label for="sys-respiratoires">
            <input type="radio" name="shuffle-filter" id="sys-respiratoires" value="sys-respiratoires">Système Respiratoire, Cavité Nasale, Larynx
          </label>
          <label for="sys-digestif">
            <input type="radio" name="shuffle-filter" id="sys-digestif" value="sys-digestif">Système Digestif : foie, Pancréa, Estomac
          </label>
          <label for="coeur">
            <input type="radio" name="shuffle-filter" id="coeur" value="coeur">Le Coeur et le Système Circulatoire
          </label>
          <label for="sys-urinaire">
            <input type="radio" name="shuffle-filter" id="sys-urinaire" value="sys-urinaire">Système Urinaire: Vessien masculine, Rein
          </label>
          <label for="bassin">
            <input type="radio" name="shuffle-filter" id="bassin" value="bassin">Bassin feminin et masculin
          </label>
          <label for="pelvis">
            <input type="radio" name="shuffle-filter" id="pelvis" value="pelvis">Pelvis avec foeutus
          </label>
          <label for="peau">
            <input type="radio" name="shuffle-filter" id="peau" value="peau">Peau
          </label>
          <label for="torses">
            <input type="radio" name="shuffle-filter" id="torses" value="torses">Torses Humains
          </label>
          <label for="musculature">
            <input type="radio" name="shuffle-filter" id="musculature" value="musculature">Musculature de la tête
          </label>
          <label for="muscles">
            <input type="radio" name="shuffle-filter" id="muscles" value="muscles">Muscles, Epaules, Bras, Jambes
          </label>
          <label for="squellettes">
            <input type="radio" name="shuffle-filter" id="squellettes" value="squellettes">Squellettes
          </label>
          <label for="cv">
            <input type="radio" name="shuffle-filter" id="cv" value="cv">Colonnes vertebrales
          </label>
          <label for="genoux">
            <input type="radio" name="shuffle-filter" id="genoux" value="genoux">Genoux et épaules
          </label>
          <label for="sys-squelletique">
            <input type="radio" name="shuffle-filter" id="sys-squelletique" value="sys-squelletique">Système squeletique
          </label>
          <label for="crane">
            <input type="radio" name="shuffle-filter" id="crane" value="crane">Crâne Humain
          </label>
          <label for="dentaire">
            <input type="radio" name="shuffle-filter" id="dentaire" value="dentaire">Modèles Dentaires
          </label>
          <label for="mea">
            <input type="radio" name="shuffle-filter" id="mea" value="mea">Modèles Economiques d'anatomie humaine
          </label>
