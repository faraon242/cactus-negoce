        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">ECLAIRAGE MEDICAL</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="#">ACCUEIL</a></li>
                      <li class="breadcrumb-item"><a href="#">Catégories</a></li>
                      <li class="breadcrumb-item"><a href="#"></a>ECLAIRAGE MEDICAL</li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
...
<section id="main-container" class="main-container">
  <div class="container text-center">
    ...
    <div class="text-center mb-4">
      <blockquote>
      <p>
        Pendant que vous ! Vous vous occupez de vos patients
        CACTUS NEGOCE Se charge de votre éclairage.
        Une bonne vision et un bon éclairage vont de soi.
        C‘est pourquoi, il va de soi également que nous prenions en compte les tendances actuelles pour vous proposer les dernières découvertes des concepts d‘éclairage Innovants.
        La solution d’éclairage sûre et fiable est très importante, particulièrement dans le domaine de la santé.
      </p>
      </blockquote>
    </div>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="shuffle-btn-group">
          ...
          <label for="lunettes-protection">
            <input type="radio" name="shuffle-filter" id="lunettes-protection" value="lunettes-protection">Lunettes de Protection
          </label>
          <label for="ecrans-visiere">
            <input type="radio" name="shuffle-filter" id="ecrans-visiere" value="ecrans-visiere">Ecrans à visière
          </label>
          <label for="ecran-teti">
            <input type="radio" name="shuffle-filter" id="ecran-teti" value="ecran-teti">Ecran de protection TETI
          </label>
          <label for="ecran-protecteur">
            <input type="radio" name="shuffle-filter" id="ecran-protecteur" value="ecran-protecteur">Ecran protecteur
          </label>
          <label for="kit-lunettes">
            <input type="radio" name="shuffle-filter" id="kit-lunettes" value="kit-lunettes">Kit de lunettes
          </label>
          <label for="mhp">
            <input type="radio" name="shuffle-filter" id="mhp" value="mhp">Masque Haute protection
          </label>
          <label for="masques-filtrant">
            <input type="radio" name="shuffle-filter" id="masques-filtrant" value="masques-filtrant">Masques Filtrants 99%
          </label>
          <label for="masques-moule">
            <input type="radio" name="shuffle-filter" id="masques-moule" value="masques-moule">Masque Moulé
          </label>
          ...
          <label for="cvp">
            <input type="radio" name="shuffle-filter" id="cvp" value="cvp">Casaque, Veste et Pantalon non tissés
          </label>
          <label for="kit-visiteur">
            <input type="radio" name="shuffle-filter" id="kit-visiteur" value="kit-visiteur">Kit Habillage pour visiteur
          </label>
          <label for="serviettes">
            <input type="radio" name="shuffle-filter" id="serviettes" value="serviettes">Serviettes
          </label>
          <label for="charlottes">
            <input type="radio" name="shuffle-filter" id="charlottes" value="charlottes">Charlottes
          </label>
          <label for="couvres-chaussures">
            <input type="radio" name="shuffle-filter" id="couvres-chaussures" value="couvres-chaussures">Couvre Chaussures
          </label>
          <label for="bavettes">
            <input type="radio" name="shuffle-filter" id="bavettes" value="bavettes">Bavettes
          </label>
          <label for="tcp">
            <input type="radio" name="shuffle-filter" id="tcp" value="tcp">Tabliers, Casaques et Pantalons
          </label>
          <label for="vestes-btn">
            <input type="radio" name="shuffle-filter" id="vestes-btn" value="vestes-btn">Veste à boutons-pression et pantalons
          </label>
          <label for="veste-dentiste">
            <input type="radio" name="shuffle-filter" id="veste-dentiste" value="veste-dentiste">Veste pour Dentistes
          </label>
          <label for="sabots">
            <input type="radio" name="shuffle-filter" id="sabots" value="sabots">Sabots et Chaussures professionnelles Ultra-Legères
          </label>
