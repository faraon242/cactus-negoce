    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4">
        <div class="sidebar sidebar-left">
          <div class="widget">
            <h3 class="widget-title">SOUS-CATEGORIES</h3>
            <ul class="nav service-menu">
              <li class="active"><a href="#">Equipements de protection individuel</a></li>
              <li><a href="prevention.php">Prévention</a></li>
              <li><a href="protection-environnement.php">Protection de l'environnement</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Equipements de protection individuel</h2>
